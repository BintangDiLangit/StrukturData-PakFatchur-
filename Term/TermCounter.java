...
/*
 ...
 jadi setiap kata kunci akan di cari lalu dihitung jumlah banyaknya kata kunci tersebut.
 */
public class TermCounter {
    ...
    public int size() {
        int total = 0;
        for (Integer value: map.values()) {// Untuk setiap value dalam map.values(), maka lakukan perulangan
            total += value;
        }
        return total;
    }
    ...
    public void processElements(Elements paragraphs) {
        for (Node node: paragraphs) {// Untuk setiap node dalam paragraphs, maka lakukan perulangan
    ...
    public Integer get(String term) {
        ...
        return count == null ? 0 : count; //jika count == null maka assign int 0, sebaliknya jika count != null maka assign ke count
    }
    ...
    /*
     ...
     method ini befungsi untuk menampilkan hasil keyword dan jumlah banyaknya per keyword
     */
